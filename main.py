...
def structure(client, region, raw, services):
    ...
    prompt = (
        ...
        "Donne 6 clusters (les plus pertinents selon les services reels du client, "
        "sans inventer de cluster mince ou redondant). Reponds UNIQUEMENT en JSON : " + SCHEMA
    )
...
def refine_result(prev, instruction, region):
    prompt = (
        ...
        "complet (garde 6 clusters, conserve note_donnees et sources_recommandees). "
